...
public class GUI extends JFrame {
    ...
    ArrayList<ClickableObject> ClickableObjects = new ArrayList<ClickableObject>();
    ...
    public static void main(String[] args)
    {
        ...
        BiConsumer<RenderObject, Graphics> renderRect = (cRenderObject, graphics) -> {
            graphics.fillRect(cRenderObject.posX, cRenderObject.posY, cRenderObject.sizeX, cRenderObject.sizeY);
        };
        ...
        Consumer<ClickableObject> onClick = (cClickableObject) -> {
            System.out.println("dogfish");
        };
